...
export function HeroROICalculator() {
  ...
  return (
    <div className="glass-card rounded-card p-6 md:p-8 shadow-[var(--shadow-card)]">
      ...
      <a
        href="/contact"
        className="group mt-6 flex min-h-[44px] w-full items-center justify-center gap-2 rounded-full bg-teal-700 px-6 py-3.5 text-base font-semibold text-white transition-all hover:bg-teal-600 glow-teal"
      >
